   ...
   if($resultado->num_rows > 0){
       if(isset($_POST['gerar'])){
           ...
           if($novaSenha == $confirmarSenha){
               ...
               $msg = "<em class='text-danger'> As senhas não conferem </em>";
           }
       }   
       ...
       echo "Bem vindo!";
   }else{#digitou pagina sem email e token
       header("location:index.php");
       exit();
   }
?>
                 ...
                 <form method="post" > <!-- envio para propria pagina-->
                      ...
                      <div class="form-group">
                          <input type="submit" value="Cadastrar senha" 
                                 class="btn btn-block btn-warning" name="gerar">
                      </div>
